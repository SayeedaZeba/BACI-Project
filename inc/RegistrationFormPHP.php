...
//calls emailChecker function to validate email
	$validate = emailchecker($_POST['vEmail']);
	if ($validate == FALSE) {
	...
	else
	{
	  ...
	  $activationCode = randomCodeGenerator(50);
		...
		$body = 'Please click on this url to activate your account. <br/>
			 <a href="http://yourwebsite.com/loginPage.php?a='.$activationCode.'" target="_blank">http://yourwebsite.com/loginPage.php?a='.$activationCode.'</a>';
